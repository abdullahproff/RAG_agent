{
  ...
  "tags": ["competency_lead", "mentoring", "professional_development", "python_development", "technical_expertise", "лидер_компетенций", "менторинг", "профессиональное_развитие", "разработка_python", "техническая_экспертиза"],
  "chunk_id": 1
}
...

{
  ...
  "specialty": "python_developer",
  "document_type": "interaction_guide",
  "tags": ["technical_standards", "python_architecture", "learning", "mentoring", "skill_development", "expert_support", "технические_стандарты", "архитектура_python", "обучение", "менторинг", "развитие_навыков", "экспертная_поддержка"],
  "chunk_id": 2
}
...

{
  ...
  "specialty": "python_developer",
  "document_type": "interaction_guide",
  "tags": ["practical_recommendations", "meeting_preparation", "skill_development", "code_review", "практические_рекомендации", "подготовка_к_встречам", "развитие_навыков", "ревью_кода"],
  "chunk_id": 3
}
