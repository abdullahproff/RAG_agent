{
  ...
  "tags": ["competency_lead", "mentoring", "professional_development", "java_development", "technical_expertise", "лидер_компетенций", "менторинг", "профессиональное_развитие", "разработка_java", "техническая_экспертиза"],
  "chunk_id": 1
}
...

{
  ...
  "specialty": "java_developer",
  "document_type": "interaction_guide",
  "tags": ["technical_standards", "java_architecture", "learning", "mentoring", "skill_development", "expert_support", "технические_стандарты", "архитектура_java", "обучение", "менторинг", "развитие_навыков", "экспертная_поддержка"],
  "chunk_id": 2
}
