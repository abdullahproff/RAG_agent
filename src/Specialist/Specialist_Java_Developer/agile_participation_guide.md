{
  ...
  "document_type": "agile_participation_guide",
  "tags": ["agile", "scrum", "grooming", "planning", "daily_standup", "java_developer", "agile", "scrum", "груминг", "планирование", "дейли", "java_разработчик"],
  "chunk_id": 1
}

РОЛЬ: Specialist; СПЕЦИАЛЬНОСТЬ: Java Developer; ТЕМА: Участие Java разработчика в Agile процессах

# Участие Java разработчика в Agile процессах

## Введение в Agile участие

### Роль Java разработчика в Agile команде:
Java разработчик является ключевым участником Agile команды, отвечающим за техническую реализацию требований и обеспечение качества кода.
...
### Роль Java разработчика в груминге:
...
- Использовать Spring Security для аутентификации
...
Зависимости: Настройка JWT secret в конфигурации
*/
```
...

{
  ...
  "specialty": "java_developer",
  "document_type": "agile_participation_guide",
  "tags": ["sprint_planning", "capacity_planning", "technical_dependencies", "story_point_estimation", "планирование_спринта", "планирование_мощностей", "технические_зависимости", "оценка_стори_поинтов"],
  "chunk_id": 2
}

РОЛЬ: Specialist; СПЕЦИАЛЬНОСТЬ: Java Developer; ТЕМА: Участие в планировании спринта

## Участие в Sprint Planning

### Роль Java разработчика в планировании:
...
Подзадачи:
1. Создать User entity и repository (2 часа)
2. Реализовать UserService с бизнес-логикой (4 часа)
3. Создать UserController с CRUD операциями (3 часа)
4. Написать unit тесты (2 часа)
...
- **Выбор технологий**: Определение используемых фреймворков и библиотек
...
- **Технические блокеры**: Выявление и планирование устранения

{
  "role": "specialist",
  "specialty": "java_developer",
  "document_type": "agile_participation_guide",
  "tags": ["daily_standup", "progress_reporting", "blocker_identification", "team_collaboration", "дейли_стендап", "отчет_о_прогрессе", "выявление_блокеров", "командное_сотрудничество"],
  "chunk_id": 3
}

РОЛЬ: Specialist; СПЕЦИАЛЬНОСТЬ: Java Developer; ТЕМА: Участие в Daily Standup

## Участие в Daily Standup

### Структура Daily Standup для Java разработчика:
...
написал unit тесты с покрытием 85%, провел code review 
для коллеги. Сегодня планирую создать UserController 
...
столкнулся с проблемами аутентификации. Сегодня 
планирую разобраться с документацией API и 
решить проблему. Блокер: нужна помощь DevOps 
с настройкой SSL сертификатов."
```
...

{
  ...
  "specialty": "java_developer",
  "document_type": "agile_participation_guide",
  "tags": ["sprint_review", "demo_preparation", "technical_presentation", "feedback_collection", "обзор_спринта", "подготовка_демо", "техническая_презентация", "сбор_обратной_связи"],
  "chunk_id": 4
}

РОЛЬ: Specialist; СПЕЦИАЛЬНОСТЬ: Java Developer; ТЕМА: Участие в Sprint Review

## Участие в Sprint Review

### Роль Java разработчика в обзоре спринта:
...

{
  ...
  "specialty": "java_developer",
  "document_type": "agile_participation_guide",
  "tags": ["retrospective", "process_improvement", "technical_debt", "team_improvement", "ретроспектива", "улучшение_процесса", "технический_долг", "улучшение_команды"],
  "chunk_id": 5
}

РОЛЬ: Specialist; СПЕЦИАЛЬНОСТЬ: Java Developer; ТЕМА: Участие в Retrospective

## Участие в Retrospective

### Роль Java разработчика в ретроспективе:
