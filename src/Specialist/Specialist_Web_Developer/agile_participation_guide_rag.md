```json
{
  ...
  "tags": ["agile", "scrum", "grooming", "planning", "daily_standup", "web_developer", "frontend", "react", "vue", "javascript", "груминг", "планирование", "дейли", "веб_разработчик"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "agile_participation_guide",
  "tags": ["grooming", "technical_estimation", "frontend_architecture", "ui_ux_requirements", "story_points", "груминг", "техническая_оценка", "архитектура_фронтенда", "ui_ux_требования", "стори_поинты"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "agile_participation_guide",
  "tags": ["sprint_planning", "capacity_planning", "frontend_dependencies", "ui_components", "планирование_спринта", "планирование_мощностей", "фронтенд_зависимости", "ui_компоненты"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "agile_participation_guide",
  "tags": ["daily_standup", "frontend_progress", "ui_issues", "browser_compatibility", "дейли_стендап", "прогресс_фронтенда", "ui_проблемы", "совместимость_браузеров"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "agile_participation_guide",
  "tags": ["sprint_review", "ui_demo", "user_experience", "frontend_performance", "обзор_спринта", "демо_интерфейса", "пользовательский_опыт", "производительность_фронтенда"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "agile_participation_guide",
  "tags": ["retrospective", "frontend_quality", "ui_ux_improvements", "browser_testing", "ретроспектива", "качество_фронтенда", "улучшения_ui_ux", "тестирование_браузеров"]
}
```
