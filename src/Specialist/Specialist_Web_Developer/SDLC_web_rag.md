```json
{
  ...
  "tags": ["sdlc", "software_development_lifecycle", "development_process", "team_roles", "web_developer", "жизненный_цикл_разработки", "процесс_разработки", "роли_команды", "веб_разработчик"]
}
```
