```json
{
  ...
  "tags": ["competency_lead", "mentoring", "professional_development", "web_development", "technical_expertise", "лидер_компетенций", "менторинг", "профессиональное_развитие", "разработка_веб", "техническая_экспертиза"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "interaction_guide",
  "tags": ["technical_standards", "web_architecture", "learning", "mentoring", "skill_development", "expert_support", "технические_стандарты", "архитектура_веб", "обучение", "менторинг", "развитие_навыков", "экспертная_поддержка"]
}
```
