{
  ...
  "tags": ["time_management", "productivity", "planning", "prioritization", "focus", "управление_временем", "продуктивность", "планирование", "приоритизация", "фокус"],
  "chunk_id": 1
}

РОЛЬ: Specialist; СПЕЦИАЛЬНОСТЬ: Analyst; ТЕМА: Основы управления временем и продуктивности

# Как мне всё успевать? Управление временем для аналитика

## Главный ответ: Никак

### Реальность:
Полностью "всё успеть" невозможно. Вместо этого нужно научиться эффективно управлять приоритетами и фокусом.
...
### Ключевой принцип:
**Стратегия — это не тратить время на пустяки**

### Ожидаемый результат:
Использование описанных техник позволит утроить (3x) производительность в повседневной жизни.

{
  "role": "specialist",
  "specialty": "analyst",
  "document_type": "time_management_guide",
  "tags": ["strategic_planning", "goal_setting", "eisenhower_matrix", "smart_goals", "стратегическое_планирование", "постановка_целей", "матрица_эйзенхауэра", "smart_цели"],
  "chunk_id": 2
}

РОЛЬ: Specialist; СПЕЦИАЛЬНОСТЬ: Analyst; ТЕМА: Стратегическое планирование и постановка целей
...

{
  ...
  "specialty": "analyst",
  "document_type": "time_management_guide",
  "tags": ["tactical_execution", "task_tracking", "pomodoro_technique", "feedback_loops", "тактическое_выполнение", "отслеживание_задач", "техника_помодоро", "обратная_связь"],
  "chunk_id": 3
}

РОЛЬ: Specialist; СПЕЦИАЛЬНОСТЬ: Analyst; ТЕМА: Тактическое выполнение задач
...

{
  ...
  "specialty": "analyst",
  "document_type": "time_management_guide",
  "tags": ["continuous_process", "regular_review", "productivity_multiplier", "implementation", "непрерывный_процесс", "регулярный_пересмотр", "множитель_продуктивности", "внедрение"],
  "chunk_id": 4
}

РОЛЬ: Specialist; СПЕЦИАЛЬНОСТЬ: Analyst; ТЕМА: Непрерывность процесса и регулярные пересмотры
...
- **Приоритизация задач**: Фокус на критически важных требованиях
- **Взаимодействие с командой**: Планирование встреч и коммуникации
- **Документирование**: Регулярное обновление документации
...

{
  ...
  "specialty": "analyst",
  "document_type": "time_management_guide",
  "tags": ["additional_resources", "books", "videos", "learning_materials", "дополнительные_ресурсы", "книги", "видео", "учебные_материалы"],
  "chunk_id": 5
}

РОЛЬ: Specialist; СПЕЦИАЛЬНОСТЬ: Analyst; ТЕМА: Дополнительные материалы для изучения
...
### Дополнительные ресурсы для аналитика:
- **Методологии**: Agile, Scrum, Kanban для планирования
- **Инструменты**: Jira, Confluence, Trello для организации работы
- **Техники**: Mind mapping, User Story mapping для анализа
- **Практики**: Time blocking, Deep work для фокусированной работы

### Small reminder:
- **Вопрос**: Как мне всё успевать?
- **Ответ**: Никак.
- **Решение**: Эффективное управление приоритетами и фокусом