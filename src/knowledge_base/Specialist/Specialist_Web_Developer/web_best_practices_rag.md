```json
{
  ...
  "tags": ["web_best_practices", "clean_code", "frontend_architecture", "performance", "security", "лучшие_практики_веб", "чистый_код", "архитектура_фронтенда", "производительность", "безопасность"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "best_practices_guide",
  "tags": ["clean_code", "naming_conventions", "code_structure", "documentation", "чистый_код", "соглашения_по_именованию", "структура_кода", "документация"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "best_practices_guide",
  "tags": ["frontend_architecture", "component_design", "state_management", "folder_structure", "архитектура_фронтенда", "дизайн_компонентов", "управление_состоянием", "структура_папок"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "best_practices_guide",
  "tags": ["performance_optimization", "bundle_optimization", "lazy_loading", "caching", "оптимизация_производительности", "оптимизация_бандла", "ленивая_загрузка", "кэширование"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "best_practices_guide",
  "tags": ["security_best_practices", "xss_prevention", "csrf_protection", "input_validation", "лучшие_практики_безопасности", "защита_от_xss", "защита_от_csrf", "валидация_ввода"]
}
```
...
```json
{
  ...
  "specialty": "web_developer",
  "document_type": "best_practices_guide",
  "tags": ["accessibility", "aria_labels", "keyboard_navigation", "screen_readers", "доступность", "aria_метки", "навигация_с_клавиатуры", "экранные_читалки"]
}
```
