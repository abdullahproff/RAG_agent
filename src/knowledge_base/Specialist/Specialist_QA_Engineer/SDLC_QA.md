{
  ...
  "tags": ["sdlc", "software_development_lifecycle", "development_process", "team_roles", "qa_engineer", "жизненный_цикл_разработки", "процесс_разработки", "роли_команды", "qa_тестировщик"],
  "chunk_id": 1
}
