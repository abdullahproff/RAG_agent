{
  ...
  "tags": ["java_best_practices", "clean_code", "design_patterns", "performance", "security", "лучшие_практики_java", "чистый_код", "паттерны_проектирования", "производительность", "безопасность"],
  "chunk_id": 1
}
...

{
  ...
  "specialty": "java_developer",
  "document_type": "best_practices_guide",
  "tags": ["design_patterns", "creational_patterns", "structural_patterns", "behavioral_patterns", "паттерны_проектирования", "порождающие_паттерны", "структурные_паттерны", "поведенческие_паттерны"],
  "chunk_id": 3
}
...

{
  ...
  "specialty": "java_developer",
  "document_type": "best_practices_guide",
  "tags": ["performance_optimization", "memory_management", "garbage_collection", "profiling", "оптимизация_производительности", "управление_памятью", "сборщик_мусора", "профилирование"],
  "chunk_id": 4
}
...

{
  ...
  "specialty": "java_developer",
  "document_type": "best_practices_guide",
  "tags": ["security_best_practices", "input_validation", "authentication", "authorization", "encryption", "лучшие_практики_безопасности", "валидация_ввода", "аутентификация", "авторизация", "шифрование"],
  "chunk_id": 5
}
