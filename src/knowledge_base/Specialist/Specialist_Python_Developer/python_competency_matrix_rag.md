{
  ...
  "tags": ["python_competency_matrix", "junior", "middle", "senior", "lead", "soft_skills", "hard_skills", "матрица_компетенций_python", "джуниор", "мидл", "сеньор", "лид", "софт_скиллы", "хард_скиллы"],
  "chunk_id": 1
}
...

{
  ...
  "specialty": "python_developer",
  "document_type": "competency_matrix",
  "tags": ["middle_developer", "advanced_python", "api_development", "orm", "testing", "docker", "мидл_разработчик", "продвинутый_python", "разработка_api", "орм", "тестирование", "докер"],
  "chunk_id": 2
}
...

{
  ...
  "specialty": "python_developer",
  "document_type": "competency_matrix",
  "tags": ["senior_developer", "architecture", "microservices", "performance", "kubernetes", "сеньор_разработчик", "архитектура", "микросервисы", "производительность", "кубернетес"],
  "chunk_id": 3
}
...

{
  ...
  "specialty": "python_developer",
  "document_type": "competency_matrix",
  "tags": ["lead_developer", "team_leadership", "technical_leadership", "system_architecture", "team_management", "лид_разработчик", "лидерство_команды", "техническое_лидерство", "системная_архитектура", "управление_командой"],
  "chunk_id": 4
}
