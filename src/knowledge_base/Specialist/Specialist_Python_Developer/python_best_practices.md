{
  ...
  "tags": ["python_best_practices", "clean_code", "design_patterns", "performance", "security", "лучшие_практики_python", "чистый_код", "паттерны_проектирования", "производительность", "безопасность"],
  "chunk_id": 1
}
...

{
  ...
  "specialty": "python_developer",
  "document_type": "best_practices_guide",
  "tags": ["performance_optimization", "memory_management", "profiling", "caching", "оптимизация_производительности", "управление_памятью", "профилирование", "кэширование"],
  "chunk_id": 4
}
...

{
  ...
  "specialty": "python_developer",
  "document_type": "best_practices_guide",
  "tags": ["security", "input_validation", "authentication", "authorization", "безопасность", "валидация_ввода", "аутентификация", "авторизация"],
  "chunk_id": 5
}
